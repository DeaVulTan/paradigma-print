            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-left">
                    <ul class="nav navbar-nav">
                        <li>
                            <a href="http://demo-cms.vitubo.com/document/cms/" title="<?php echo __('Documentation', 'admin_theme'); ?>" target="_blank" class="icon-front-page">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <div class="footer" style="background:#FFFFFF;">
                    <div class="inner">
                        Copyright &copy; <?php echo date("Y"); ?> <strong>Vitubo CMS</strong> Version <?php echo PF_VERSION; ?>
                    </div>
                </div>
                <!-- end Ticket #494-->
            </aside><!-- /.right-side -->
