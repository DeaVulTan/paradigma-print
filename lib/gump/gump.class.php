...
class GUMP
{
    ...
    public function get_readable_errors($convert_to_string = false, $field_class="field", $error_class="error-message")
    {
        ...
        foreach($this->errors as $e) {
            if (!empty($this->label[$e['field']])){
                $field = $this->label[$e['field']];
            }else{
            ...
            switch($e['rule']) {
                ...
                case 'validate_required':
                    $resp[$e['field']][] = __("The ","includes")."<span class=\"$field_class\">$field</span> ".__("field is required","includes");
                    break;
                case 'validate_required_number':
                    $resp[$e['field']][] = __("The ","includes")."<span class=\"$field_class\">$field</span> ".__("field is required","includes");
                    break;
                case 'validate_valid_email':
                    $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field is required to be a valid email address","includes");
                    break;
                case 'validate_max_len':
                    if($param == 1) {
                        $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field needs to be shorter than","includes")." $param ".__("characters","includes");
                    } else {
                        $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field needs to be shorter than","includes")." $param ".__("characters","includes");
                    }
                    break;
                ...
                case 'validate_exact_len':
                    if($param == 1) {
                        $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field needs to be exactly","includes")." $param ".__("characters in length","includes");
                    } else {
                        $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field needs to be exactly","includes")." $param ".__("characters in length","includes");
                    }
                    break;
                case 'validate_alpha':
                    $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field may only contain alpha characters(a-z)","includes");
                    break;
                case 'validate_alpha_space':
                    $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field may only contain alpha and space characters.","includes");
                    break;
                case 'validate_alpha_numeric':
                    $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field may only contain alpha-numeric characters","includes");
                    break;
                case 'validate_alpha_dash':
                    $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field may only contain alpha characters &amp; dashes","includes");
                    break;
                case 'validate_numeric':
                    $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field may only contain numeric characters","includes");
                    break;
                case 'validate_integer':
                    $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field may only contain a numeric value","includes");
                    break;
                case 'validate_boolean':
                    $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field may only contain a true or false value","includes");
                    break;
                case 'validate_float':
                    $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field may only contain a float value","includes");
                    break;
                case 'validate_valid_url':
                    $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field is required to be a valid URL","includes");
                    break;
                case 'validate_url_exists':
                    $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("URL does not exist","includes","includes");
                    break;
                case 'validate_valid_ip':
                    $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field needs to contain a valid IP address","includes");
                    break;
                case 'validate_valid_cc':
                    $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field needs to contain a valid credit card number","includes");
                    break;
                case 'validate_valid_name':
                    $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field needs to contain a valid human name","includes");
                    break;
                case 'validate_contains':
                    $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field needs to contain one of these values","includes").": ".implode(', ', $param);
                    break;
                case 'validate_street_address':
                    $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field needs to be a valid street address","includes");
                    break;
                case 'validate_date':
                    $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field needs to be a valid date (yyyy-dd-mm)","includes");
                    break;
                case 'validate_min_numeric':
                    $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field needs to be a numeric value, equal to, or higher than ","includes").$param;
                    break;
                case 'validate_max_numeric':
                    $resp[$e['field']][] = __("The ","includes")." <span class=\"$field_class\">$field</span> ".__("field needs to be a numeric value, equal to, or lower than ","includes").$param;
                    break;
            }
        }
    ...
    */
     ...
     * @return mixed
     */
    protected function validate_required_number($field, $input, $param = NULL)
    {
        if(isset($input[$field]) && (!empty($input[$field]) || $input[$field] != '0'  || $input[$field] != 0))
        {
            return;
    ...
    /**
     * Determine if the provided value contains only alpha and space characters
     *
    ...
    protected function validate_alpha_space($field, $input, $param = NULL)
    {
        ...
        if(!preg_match("/^[A-Za-z ]*$/", $input[$field]) !== FALSE)
        {
            return array(
                    'field' => $field,
                    'value' => $input[$field],
    ...
    public static function is_valids($token, $key = '',$remove = true)
    {
