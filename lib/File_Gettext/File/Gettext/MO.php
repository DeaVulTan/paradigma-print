...
class File_Gettext_MO extends File_Gettext
{
     ...
     * @return  int
     */
    private function _readInt($bigendian = false)
    {
        $array = unpack($bigendian ? 'N' : 'V', $this->_read(4));
     ...
     * @return  int
     */
    private function _writeInt($int)
    {
     ...
     * @return  int
     */
    private function _writeStr($string)
    {
