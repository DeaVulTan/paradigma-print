...
(function(t,i,e,s){
	"use strict";
		function n(i,e){
			this.$element=t(i),
			this.options=t.extend(!0,{},r,e),
			this.colHeightArray=[],this.styleQueue=[],
			this._init()
		}
		var o=t(i),
		a="waterfall",
		r={
			...
			callbacks:{loadingStart:function(t){t.show()},
			loadingFinished:function(t,i){i?t.remove():t.fadeOut()},
			loadingError:function(t){t.html("Data load faild, please try again later.")},
			renderData:function(i,e){var s,n;return"json"===e||"jsonp"===e?(s=t("#waterfall-tpl").html(),
			n=Handlebars.compile(s),n(i)):i}},debug:!1};
			n.prototype={
