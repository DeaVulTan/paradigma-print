...
<div class="row" style="margin-bottom: 20px;margin-top:-15px;">
    <div class="col-sm-12">
        <h3>
            ...
            <?php } ?>
            <?php echo __('Portfolios','portfolio'); ?>  <small><?php echo __('Add','portfolio'); ?></small>
        </h3>
    </div>
</div>
<div class="row">
    <div class="col-sm-12">
        <form name="frm_Portfolio_New" id="frm_Portfolio_New" class="form-horizontal" role="form" action="<?php echo admin_url(); ?>" method="post" onsubmit="return false;">
            ...
            <div class="form-group <?php $this->error_class("portfolio_avatar");?>">
                ...
                <div class="col-sm-10">
                    <div class= "col-sm-12" style="padding-right:0px;">
                        ...
                        ?>
                        <input type="hidden" id="set_thumb" name="avatar" value="<?php echo $this->controller->post->avatar?>">
                    </div>
                    <div class= "col-sm-12">
            ...
            <div class="form-group <?php $this->error_class("portfolio_status");?>">
                ...
                <div class="col-sm-10">
                    ...
                    <label class="checkbox-inline" style="padding-left:0px;">
                        <?php echo form_checkbox('portfolio_status','1',$checked); ?>
            ...
            <?php echo Pf::event()->trigger("filter","portfolio-adding-form"); ?>
        </form>
    </div>
</div>
...
function Portfolio_New(){
	...
	$.post($('#frm_Portfolio_New').attr('action'),$('#frm_Portfolio_New').serialize(),function(obj){
		$("#main-content").unmask();
		if (obj.error == 1){
