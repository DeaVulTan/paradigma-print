...
<?php 
    ...
    $search_btn .= form_button("<i class='fa fa-search'></i> ".__('Search','portfolio'), array('onclick' => 'Category_Search_modal()','style' => 'display:none', 'class' => 'btn btn-default btn-index'));
    ...
    $search_btn .= form_button("<i class='fa fa-times'></i>", array('onclick' => 'cancel_Category_Search()','style' => 'display:none', 'class' => 'btn btn-default btn-index'));
    $search_btn .= '</div>';
    add_toolbar_button($search_btn); ?>
<?php add_toolbar_button(form_button("<i class='fa fa-plus'></i> ".__('New','portfolio'), array('onclick' => 'Category_Add();','style' => 'display:none', 'class' => 'btn btn-primary btn-index'))); ?>
<!-- /index -->

<!-- add -->
<?php add_toolbar_button(form_button("<i class='fa fa-check-circle'></i> ".__('Save','portfolio'), array('onclick' => 'Category_New();','style' => 'display:none', 'class' => 'btn btn-primary btn-add'))); ?>
...
<!-- edit -->
<?php add_toolbar_button(form_button("<i class='fa fa-check-circle'></i> ".__('Save','portfolio'), array('onclick' => 'Category_Edit();','style' => 'display:none', 'class' => 'btn btn-primary btn-edit'))); ?>
<?php add_toolbar_button(form_button("<i class='fa fa-check-circle'></i> ".__('Apply','portfolio'), array('onclick' => 'Category_Apply();','style' => 'display:none', 'class' => 'btn btn-info btn-edit'))); ?>
...
<!-- copy -->
<?php add_toolbar_button(form_button("<i class='fa fa-check-circle'></i> ".__('Save','portfolio'), array('onclick' => 'Category_Copy();','style' => 'display:none', 'class' => 'btn btn-primary btn-copy'))); ?>
...
<div class="row" style="margin-bottom: 20px; margin-top: -15px;">
    <div class="col-sm-12">
        <h3>
            ...
            <?php } ?>
            <?php echo __('Category','portfolio'); ?>  <small><?php echo __('List','portfolio'); ?></small>
        </h3>
    </div>
</div>
    ...
    <div class="col-md-6">
        <div class="btn-group" >
            <button type="button"
                class="btn btn-default dropdown-toggle"
                data-toggle="dropdown">
                <span id="view-title"><?php echo __('All','portfolio'); ?></span>  
                <span class="caret"></span>
            </button>
            <ul class="dropdown-menu" role="menu">
                <li>
                    <a href="<?php echo admin_url("admin-page=portfolio&sub_page=category", false); ?>"><?php echo __('All','portfolio'); ?></a>
                </li>
                <li>
    ...
    <div class="col-sm-12">
        <div class="table-responsive">
            ...
            <th style="background:#3c8dbc; color:white; width:200px; ">
                ...
                ?>
                <div style="cursor:pointer; position: relative;" id="order_category_name" onclick="Category_Oder(this,'category_name');">
            ...
            <th style="background:#3c8dbc; color:white;">
                ...
                ?>
                <div style="cursor:pointer; position: relative;" id="order_category_description" onclick="Category_Oder(this,'category_description');">
            ...
            <th style="background:#3c8dbc; color:white; width:100px;">
                ...
                ?>
                <div style="cursor:pointer; position: relative;" id="order_category_status" onclick="Category_Oder(this,'category_status');">
            ...
            <td><?php echo '{portfolio:display catid='.$record["id"].'}'; ?></td> 
            <td><?php echo $this->controller->category_model->cut($record["category_description"],80, $more=" ...") ?></td>
            <td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo __('Category','portfolio'); ?> <?php echo __('Search','portfolio'); ?> </h4>
            </div>
            <form name="frm_Category_Search" id="frm_Category_Search" class="form-horizontal" role="form" onsubmit="return false;">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="row"><?php foreach($this->controller->category_model->elements_value["category_status"] as $k => $v){ ?>    <label class="checkbox-inline"><?php echo form_checkbox("search[category_status][]",$k,(isset($this->controller->get->search["category_status"]) && in_array($k,$this->controller->get->search["category_status"]))?true:false);?> <?php echo __($v,'portfolio'); ?></label><?php }?></div>
                </div>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="Category_Search();"> <i class='fa fa-search'></i> <?php echo __('Search','portfolio'); ?></button>
