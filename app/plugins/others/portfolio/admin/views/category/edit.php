...
<div class="row" style="margin-bottom: 20px;margin-top:-15px;">
    <div class="col-sm-12">
        <h3>
            ...
            <?php } ?>
            <?php echo __('Category','portfolio'); ?>  <small><?php echo __('Edit','portfolio'); ?></small>
        </h3>
    </div>
</div>
<div class="row">
    <div class="col-sm-12">
        <form name="frm_Category_Edit" id="frm_Category_Edit" class="form-horizontal" role="form" action="<?php echo admin_url('token='.$this->token); ?>" method="post" onsubmit="return false;">
            ...
            <?php echo Pf::event()->trigger("filter","category-editing-form"); ?>
        </form>
    </div>
</div>
<script>
...
function Category_Edit(){
	...
	$.post($('#frm_Category_Edit').attr('action'),$('#frm_Category_Edit').serialize(),function(obj){
		$("#main-content").unmask();
		if (obj.error == 1){
