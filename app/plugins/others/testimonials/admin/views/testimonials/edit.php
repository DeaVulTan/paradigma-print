...
<div class="row" style="margin-bottom: 20px;margin-top:-15px;">
    <div class="col-sm-12">
        <h3>
            ...
            <?php } ?>
            <?php echo __('Testimonials','testimonials'); ?>  <small><?php echo __('Edit','testimonials'); ?></small>
        </h3>
    </div>
</div>
<div class="row">
    <div class="col-sm-12">
        <form name="frm_Testimonials_Edit" id="frm_Testimonials_Edit" class="form-horizontal" role="form" action="<?php echo admin_url('token='.$this->token); ?>" method="post" onsubmit="return false;">
            <div class="row pad">
...
function Testimonials_Edit(){
	...
	$.post($('#frm_Testimonials_Edit').attr('action'),$('#frm_Testimonials_Edit').serialize(),function(obj){
		$("#main-content").unmask();
		if (obj.error == 1){
