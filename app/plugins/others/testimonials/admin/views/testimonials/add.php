...
<div class="row" style="margin-bottom: 20px;margin-top:-15px;">
    <div class="col-sm-12">
        <h3>
            ...
            <?php } ?>
            <?php echo __('Testimonials','testimonials'); ?>  <small><?php echo __('Add','testimonials'); ?></small>
        </h3>
    </div>
</div>
<div class="row">
    <div class="col-sm-12">
        <form name="frm_Testimonials_New" id="frm_Testimonials_New" class="form-horizontal" role="form" action="<?php echo admin_url(); ?>" method="post" onsubmit="return false;">
            <div class="row pad">
                <div class="col-md-12" id="col-md-12">
                    ...
                    <?php echo Pf::event()->trigger("filter","testimonials-adding-form"); ?>
                </div>
            </div>
        </form>
    </div>
...
function Testimonials_New(){
	$("#main-content").mask("<?php echo __('Loading...','testimonials'); ?>");
	try{
	   tinymce.triggerSave(); 
        tinymce.remove();
    }catch(e){}
	$.post($('#frm_Testimonials_New').attr('action'),$('#frm_Testimonials_New').serialize(),function(obj){
		$("#main-content").unmask();
		if (obj.error == 1){
...
$("#fix-image > div > span > a").text("<?php echo __('Choose Image','testimonials');?>");
</script>