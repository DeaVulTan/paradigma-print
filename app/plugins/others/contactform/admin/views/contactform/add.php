...
<div class="row" style="margin-bottom: 20px; margin-top: -15px;">
	<div class="col-sm-12">
		<h3>
            ...
            <?php } ?>
            <?php echo __('Contact Forms','contactform'); ?>  <small><?php echo __('Add','contactform'); ?></small>
		</h3>
	</div>
</div>
<div class="row">
            ...
            <div class="form-group " >
                <div class="col-sm-6" >
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                           <label><input type="radio" name="recipient" value="1" id="recipient" <?php if(!isset($contactform['mail']['config']['recipient']) || $contactform['mail']['config']['recipient'] == 1){echo 'checked="checked"';} ?> /> <?php echo __('Single Recipient', 'contactform'); ?></label>  &nbsp; 
                           <label><input type="radio" name="recipient" value="0" id="recipient" <?php if(isset($contactform['mail']['config']['recipient']) && $contactform['mail']['config']['recipient'] == 0){echo 'checked="checked"';} ?> /> <?php echo __('List of Recipient', 'contactform'); ?></label>
                        </div>
                    </div>
    	            ...
    	            <div class="form-group" id="list_of_recipient_page" <?php $this->error_class("to_list");?>>
    	                ...
    	                <div class="col-sm-8">
    	                     <?php
                                if(isset($contactform['mail']['config']['from_list']) && $contactform['mail']['config']['from_list'] != NULL){
                                    echo form_textarea(array('name' => 'to_list', 'class' => 'form-control', 'rows' => 8, 'tabindex' => 11, 'placeholder' => 'Enter Email addresses here, one Email per line.'), ($contactform['mail']['config']['from_list']));
                                }else{
...
function contactform_New(){
	...
	$.post($('#frm_contactform').attr('action'),$('#frm_contactform').serialize(),function(obj){
		...
		if (obj.error == 1){
			...
			$.notification({type:"success",img:"",width:"400",content:"<i class='fa fa-check fa-2x'></i> <?php echo __('Contact Forms is added successfully','contactform'); ?>",html:true,autoClose:true,timeOut:"1500",delay:"0",position:"topRight",effect:"fade",animate:"fadeUp",easing:"jswing",onStart:function(id){ console.log(' onStart : notification id = '+id); },onShow:function(id){ console.log(' onShow : notification id = '+id); },onClose:function(id){ console.log(' onClose : notification id = '+id); },duration:"300"});
