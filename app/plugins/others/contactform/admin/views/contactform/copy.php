...
<div class="row" style="margin-bottom: 20px; margin-top: -15px;">
	<div class="col-sm-12">
		<h3>
            ...
            <?php } ?>
            <?php echo __('Contact Forms','contactform'); ?>  <small><?php echo __('Copy','contactform'); ?></small>
		</h3>
	</div>
</div>
<div class="row">
	<div class="col-sm-12">
		<form name="frm_contactform_copy" id="frm_contactform_copy" class="form-horizontal" role="form" action="<?php echo admin_url(); ?>" method="post"onsubmit="return false;">
            ...
            <div class="form-group " >
                <div class="col-sm-6" >
                     <div class="form-group <?php $this->error_class("to");?>">
...
function contactform_Copy(){
	$("#main-content").mask("<?php echo __('Loading...','contactform'); ?>");
	try{
       tinymce.triggerSave(); 
        tinymce.remove();
    }catch(e){}
	$.post($('#frm_contactform_copy').attr('action'),$('#frm_contactform_copy').serialize(),function(obj){
		$("#main-content").unmask();
		if (obj.error == 1){
			...
			$.notification({type:"success",img:"",width:"400",content:"<i class='fa fa-check fa-2x'></i> <?php echo __('Contact Forms is copied successfully','contactform'); ?>",html:true,autoClose:true,timeOut:"1500",delay:"0",position:"topRight",effect:"fade",animate:"fadeUp",easing:"jswing",onStart:function(id){ console.log(' onStart : notification id = '+id); },onShow:function(id){ console.log(' onShow : notification id = '+id); },onClose:function(id){ console.log(' onClose : notification id = '+id); },duration:"300"});
