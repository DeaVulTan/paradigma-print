...
<div class="row" style="margin-bottom: 20px;margin-top:-15px;">
    <div class="col-sm-12">
        <h3>
            ...
            <?php } ?>
            <?php echo __('Menu','menu'); ?>  <small><?php echo __('Add','menu'); ?></small>
        </h3>
    </div>
...
<div class="row">
    <div class="col-sm-12">
        <form name="frm_Menu_New" id="frm_Menu_New" class="form-horizontal" role="form" action="<?php echo admin_url(); ?>" method="post" onsubmit="return false;">
                                    ...
                                    <colgroup><col class="col-md-2">
                                        ...
                                        <tr>
                                            ...
                                            <td id="ename">
                                                ...
                                                <input type="text" name="title" class="form-control" value="" required="yes" id="menu_title">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="cf nestable-lists">
                            ...
                            <div class="col-lg-12">
                                ...
                                <textarea id="nestable-output-data" name="json-data" class="form-control hidden" >[]</textarea>
                            </div>
                        </div>
                    </div>
                <!-- /form> -->
...
function Menu_New(){
	...
	$.post($('#frm_Menu_New').attr('action'),$('#frm_Menu_New').serialize(),function(obj){
		$("#main-content").unmask();
		if (obj.error == 1){
