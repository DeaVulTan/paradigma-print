...
?>
<?php add_toolbar_button(form_button("<i class='fa fa-plus'></i> ".__('New','post'), array('onclick' => 'Post_Add();','style' => 'display:none', 'class' => 'btn btn-primary btn-index'))); ?>
<!-- /index -->

<!-- add -->
<?php add_toolbar_button(form_button("<i class='fa fa-check-circle'></i> ".__('Save','post'), array('onclick' => 'Post_New();','style' => 'display:none', 'class' => 'btn btn-primary btn-add'))); ?>
...
<!-- edit -->
<?php add_toolbar_button(form_button("<i class='fa fa-check-circle'></i> ".__('Save','post'), array('onclick' => 'Post_Edit();','style' => 'display:none', 'class' => 'btn btn-primary btn-edit'))); ?>
<?php add_toolbar_button(form_button("<i class='fa fa-check-circle'></i> ".__('Apply','post'), array('onclick' => 'Post_Apply();','style' => 'display:none', 'class' => 'btn btn-info btn-edit'))); ?>
...
<!-- copy -->
<?php add_toolbar_button(form_button("<i class='fa fa-check-circle'></i> ".__('Save','post'), array('onclick' => 'Post_Copy();','style' => 'display:none', 'class' => 'btn btn-primary btn-copy'))); ?>
...
<div class="row" style="margin-bottom: 20px; margin-top: -15px;">
    <div class="col-sm-12">
        <h3>
            ...
            <?php } ?>
            <?php echo __('Post','post'); ?>  <small><?php echo __('List','post'); ?></small>
        </h3>
    </div>
</div>
    ...
    <div class="col-sm-12">
        <div class="table-responsive">
            <form method="post" role="form"
                ...
                <?php
                $post_title_icon = "";
                if (! empty ( $this->controller->get->order_field ) && $this->controller->get->order_field == "post_title") {
                    if (! empty ( $this->controller->get->order_type ) && strtolower ( $this->controller->get->order_type ) == "desc") {
                        $post_title_icon = "fa-sort-desc";
                    } else {
                        $post_title_icon = "fa-sort-asc";
                    }
                }
                ...
                <div style="cursor: pointer; position: relative;"
                                        id="order_post_title"
                                        onclick="Post_Oder(this,'post_title');">
                    <?php echo __("Title","post"); ?> 
                    <i class="fa fa-sort"
                                            style="position: absolute; top: 4px; right: 0; color: #7fb1ce;"></i>
                                        <i class="fa order-icon <?php echo $post_title_icon; ?>" style="position:absolute; top:4px; right:0; <?php if ($post_title_icon == ""){ ?> display:none;<?php } ?>"></i>
                                    </div>
                                </th>
                                <th
                                    style="background: #3c8dbc; color: white;width: 200px;">
                <?php
                $post_category_icon = "";
                if (! empty ( $this->controller->get->order_field ) && $this->controller->get->order_field == "post_category") {
                    if (! empty ( $this->controller->get->order_type ) && strtolower ( $this->controller->get->order_type ) == "desc") {
                        $post_category_icon = "fa-sort-desc";
                    } else {
                        $post_category_icon = "fa-sort-asc";
                    }
                }
                
                ?>
                <div style="cursor: pointer; position: relative;"
                                        id="order_post_category"
                                        onclick="Post_Oder(this,'post_category');">
                    <?php echo __("Category","post"); ?> 
                    <i class="fa fa-sort"
                                            style="position: absolute; top: 4px; right: 0; color: #7fb1ce;"></i>
                                        <i class="fa order-icon <?php echo $post_category_icon; ?>" style="position:absolute; top:4px; right:0; <?php if ($post_category_icon == ""){ ?> display:none;<?php } ?>"></i>
                                    </div>
                                </th>
                                <th
                                    style="background: #3c8dbc; color: white;width:160px">
                <?php
                $post_created_date_icon = "";
                if (! empty ( $this->controller->get->order_field ) && $this->controller->get->order_field == "post_created_date") {
                    if (! empty ( $this->controller->get->order_type ) && strtolower ( $this->controller->get->order_type ) == "desc") {
                        $post_created_date_icon = "fa-sort-desc";
                    } else {
                        $post_created_date_icon = "fa-sort-asc";
                    }
                }
                
                ?>
                <div style="cursor: pointer; position: relative;"
                                        id="order_post_created_date"
                                        onclick="Post_Oder(this,'post_created_date');">
                    <?php echo __("Created date","post"); ?> 
                    <i class="fa fa-sort"
                                            style="position: absolute; top: 4px; right: 0; color: #7fb1ce;"></i>
                                        <i class="fa order-icon <?php echo $post_created_date_icon; ?>" style="position:absolute; top:4px; right:0; <?php if ($post_created_date_icon == ""){ ?> display:none;<?php } ?>"></i>
                                    </div>
                                </th>
                                <th
                ...
                <?php
                $post_status_icon = "";
                if (! empty ( $this->controller->get->order_field ) && $this->controller->get->order_field == "post_status") {
                    if (! empty ( $this->controller->get->order_type ) && strtolower ( $this->controller->get->order_type ) == "desc") {
                        $post_status_icon = "fa-sort-desc";
                    } else {
                        $post_status_icon = "fa-sort-asc";
                    }
                }
                
                ?>
                <div style="cursor: pointer; position: relative;"
                                        id="order_post_status"
                                        onclick="Post_Oder(this,'post_status');">
                    <?php echo __("Status","post"); ?> 
                    <i class="fa fa-sort"
                                            style="position: absolute; top: 4px; right: 0; color: #7fb1ce;"></i>
                                        <i class="fa order-icon <?php echo $post_status_icon; ?>" style="position:absolute; top:4px; right:0; <?php if ($post_status_icon == ""){ ?> display:none;<?php } ?>"></i>
                                    </div>
                                </th>
                    ...
                    <tr>
                                ...
                                <td><?php echo str_to_mysqldate($record["post_created_date"],"Y-m-d",$this->controller->post_model->elements_value["post_created_date"]." A"); ?></td>
                                <td>
                                    <?php if($record['post_status'] == 1){ ?>
                                ...
                                <td class="text-center">
                                    <button type="button"
                                        onclick="Post_Copy('<?php echo (int)$record['id'];?>','<?php echo $token; ?>');"
                                        class="btn btn-primary btn-xs">
                                        <i class="fa fa-files-o"></i>
                                    </button>
                                    <button type="button"
                                        onclick="Post_Edit('<?php echo (int)$record['id'];?>','<?php echo $token; ?>');"
                                        class="btn btn-info btn-xs">
                                        <i class="fa fa-pencil"></i>
                                    </button>
                                    <button type="button"
                                        onclick="Post_Delete('<?php echo (int)$record['id'];?>','<?php echo $token; ?>');"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo __('Post','post'); ?> <?php echo __('Search','post'); ?> </h4>
            </div>
            <form name="frm_Post_Search" id="frm_Post_Search" class="form-horizontal" role="form" onsubmit="return false;">
            ...
            <div class="modal-body">
                    ...
                    <?php echo __("Title","post"); ?>
                        ...
                        <div class="col-sm-10">
                    <?php echo form_input("search[post_title]",(isset($this->controller->get->search["post_title"]))?$this->controller->get->search["post_title"]:""); ?>
                </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            $category_select = $this->list_category;
                            ...
                            echo form_dropdown ( "search[post_category]", $post_category_select, (isset ( $this->controller->get->search ["post_category"] )) ? $this->controller->get->search ["post_category"] : "" );
                            ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="row"><?php foreach($this->controller->post_model->elements_value["post_status"] as $k => $v){ ?>    <label class="checkbox-inline"><?php echo form_checkbox("search[post_status][]",$k,(isset($this->controller->get->search["post_status"]) && in_array($k,$this->controller->get->search["post_status"]))?true:false);?> <?php echo __($v,'post'); ?></label><?php }?></div>
                        </div>
                    </div>
                <?php echo Pf::event()->trigger("filter","post-search-form"); ?>
            </div>
            </form>
	                    	    ...
	                    	    $.post($('#frm-bulk-action').attr('action')+'&type='+type,$('#frm-bulk-action').serialize(),function(obj){
    	              			    $('#main-content').load(obj.url,function(){
    	              				 ...
    	              				 if (obj.error == 0){
    	              					 switch(obj.action){
         	              				        case 'delete':
         	    	              				    $.notification({type:"success",img:"",width:"400",content:"<i class='fa fa-check fa-2x'></i> <?php echo __('Post is deleted successfully','post'); ?>",html:true,autoClose:true,timeOut:"1500",delay:"0",position:"topRight",effect:"fade",animate:"fadeUp",easing:"jswing",onStart:function(id){ console.log(' onStart : notification id = '+id); },onShow:function(id){ console.log(' onShow : notification id = '+id); },onClose:function(id){ console.log(' onClose : notification id = '+id); },duration:"300"});
         	              					    break;
         	              					    case 'publish':
    	    	              				        $.notification({type:"success",img:"",width:"400",content:"<i class='fa fa-check fa-2x'></i> <?php echo __('Post is published successfully','post'); ?>",html:true,autoClose:true,timeOut:"1500",delay:"0",position:"topRight",effect:"fade",animate:"fadeUp",easing:"jswing",onStart:function(id){ console.log(' onStart : notification id = '+id); },onShow:function(id){ console.log(' onShow : notification id = '+id); },onClose:function(id){ console.log(' onClose : notification id = '+id); },duration:"300"});
    	    	              				    break;
    	    	              				    case 'unpublish':
    	    	              				        $.notification({type:"success",img:"",width:"400",content:"<i class='fa fa-check fa-2x'></i> <?php echo __('Post is unpublished successfully','post'); ?>",html:true,autoClose:true,timeOut:"1500",delay:"0",position:"topRight",effect:"fade",animate:"fadeUp",easing:"jswing",onStart:function(id){ console.log(' onStart : notification id = '+id); },onShow:function(id){ console.log(' onShow : notification id = '+id); },onClose:function(id){ console.log(' onClose : notification id = '+id); },duration:"300"});
    											break;
         	              				   }
    	              				   }else{
    	              				        $.notification({type:"error",img:"",width:"400",content:"<i class='fa fa-times-circle fa-2x'></i> <?php echo __('There is an error, please check again!','category'); ?>",html:true,autoClose:true,timeOut:"1500",delay:"0",position:"topRight",effect:"fade",animate:"fadeUp",easing:"jswing",onStart:function(id){ console.log(' onStart : notification id = '+id); },onShow:function(id){ console.log(' onShow : notification id = '+id); },onClose:function(id){ console.log(' onClose : notification id = '+id); },duration:"300"});
    	              				   }
...
function Post_Search(){
	...
	$('#search_modal').on('hidden.bs.modal', function (e) {
		$.get('<?php echo admin_url($src_param,false); ?>',$('#frm_Post_Search').serialize(),function(html){
...
function cancel_Post_Search(){
	$("#main-content").mask("<?php echo __('Loading...','post'); ?>");
	$('#main-content').load('<?php echo admin_url('&sub_page=post&search='); ?>',function(){
		$("#main-content").unmask();
		$('#main-content input[type="checkbox"]').iCheck({checkboxClass: 'icheckbox_minimal'});
		$('#main-content input[type="radio"]').iCheck({radioClass: 'iradio_minimal'});
	});
...
function back_to_list(){
	$("#main-content").mask("<?php echo __('Loading...','category'); ?>");
	try{
	   tinymce.remove();
	}catch(e){}
...
function view_allstatus(id,status) {
    $("#main-content").mask("<?php echo __('Loading...','post'); ?>");
    $.post("<?php echo admin_url('&sub_page=post'); ?>", {action: "view-status",status: status,id: id},
    	function (html) {
    	$("#main-content").unmask();
    	$('#main-content').html(html);
    	if(id == 1){
