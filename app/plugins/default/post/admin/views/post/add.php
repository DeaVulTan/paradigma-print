...
<div class="row" style="margin-bottom: 20px; margin-top: -15px;">
    <div class="col-sm-12">
        <h3>
            ...
            <?php } ?>
            <?php echo __('Post','post'); ?>  <small><?php echo __('Add','post'); ?></small>
        </h3>
    </div>
...
<div class="row">
    <div class="col-sm-12">
        <form name="frm_Post_New" id="frm_Post_New" class="form-horizontal" role="form" action="<?php echo admin_url(); ?>" method="post" onsubmit="return false;">
           ...
           <div class="row" style="margin: 0px;">
            ...
            <div class="row" style="margin: 0px;">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo form_input(array('name' => 'tags', 'data-role' => 'tagsinput', 'placeholder' => __('Add tags', 'post'), 'tabindex' => 9)); ?>
            ...
            <?php echo Pf::event()->trigger("filter","post-adding-form"); ?>
        </form>
    </div>
...
function Post_New(){
	...
	$.post($('#frm_Post_New').attr('action'),$('#frm_Post_New').serialize(),function(obj){
		$("#main-content").unmask();
		if (obj.error == 1){
			...
			$.notification({type:"success",img:"",width:"400",content:"<i class='fa fa-check fa-2x'></i> <?php echo __('Post is added successfully','post'); ?>",html:true,autoClose:true,timeOut:"1500",delay:"0",position:"topRight",effect:"fade",animate:"fadeUp",easing:"jswing",onStart:function(id){ console.log(' onStart : notification id = '+id); },onShow:function(id){ console.log(' onShow : notification id = '+id); },onClose:function(id){ console.log(' onClose : notification id = '+id); },duration:"300"});
