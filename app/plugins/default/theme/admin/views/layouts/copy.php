	...
	<div class="col-xs-12" style="overflow: auto;">
		<div class="panel panel-default">
			...
			<div class="panel-body">
			     <form method="post"  method="post" name="frm_layout_Copy" id="frm_layout_Copy" action="<?php echo admin_url('action=copy'); ?>" id="frm_layout_Copy">
					<div class="row pad">
						<div class="col-md-6">
							<div
					...
					<div class="row pad">
						<div class="col-sm-3" id="plugins">
							<ul class="sortable-list">
								<?php foreach ($this->controller->post->list_widgets as $k => $widget) { ?>
								    <?php if (!in_array($k, $this->controller->post->activate_widgets)) continue;?>
...
<script>
    ...
    $(document).ready(function(){
    	...
    	$('.btn_builder_layout1').click(function(){
    		...
    		$('#frm_layout_Copy').attr('action',$('#url_save').val());
    		$('#frm_layout_Copy').submit();
    	});
    ...
    function layout_Copy(){
    	...
    	$.post($('#frm_layout_Copy').attr('action'),$('#frm_layout_Copy').serialize(),function(obj){
    		//alert(obj);
    		$("#main-content").unmask();
    		if (obj.error == 1){
