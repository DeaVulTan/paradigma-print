...
<div class="row" style="margin-bottom: 20px;margin-top:-15px;">
    <div class="col-sm-12">
        <h3>
            ...
            <?php } ?>
            <?php echo __('Pages','page'); ?>  <small><?php echo __('Add','page'); ?></small>
        </h3>
    </div>
...
<div class="row">
    <div class="col-sm-12">
        <form name="frm_Page_New" id="frm_Page_New" class="form-horizontal" role="form" action="<?php echo admin_url(); ?>" method="post" onsubmit="return false;">
                    ...
                    <div class="tab-content">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group titleWrap <?php $this->error_class("page_title");?>">
                                            ...
                                            <div class="col-sm-11">
                                                ...
                                                echo form_input(array('type' => 'hidden', 'id' => 'visible_users_data', 'value' => '', 'name' => 'visible_users_data'));
                                                echo form_input(array('type' => 'hidden', 'id' => 'page_url', 'value' => '', 'name' => 'page_url'));
                                        ...
                                        <div class="form-group permalinkWrap" data-method="">
                                            ...
                                            <?php echo form_input(array('name' => 'url', 'type' => 'hidden', 'id' => 'slug')); ?>
                                        </div>
                                    </div>
                                </div><!--end title-->
                                <div class="row">
                        ...
                        <div id="page-visible" class="tab-pane tab-content">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 visible-group">
                                    <?php
                                    $check = !empty($_POST['visible_group']) && in_array(0, array_values($_POST['visible_group'])) ? 'checked' : '';
                                    ...
                                    foreach ($roles as $role) {
                                        $check = !empty($_POST['visible_group']) && in_array($role['id'], array_values($_POST['visible_group'])) ? 'checked' : '';
                        ...
                        <div id="settings" class="tab-pane tab-content">
                            <table class="table table-bordered table-configuration">
                                ...
                                <tr>
                                    <?php
                                    echo theme_background('background', get_value_input('background'));
                                    ?>
                                </tr>
                                <tbody class="tr-background-color">
                                    <tr class="tr-background-color">
                                        ...
                                        <td>
                                            <?php
                                            echo theme_input_color('background-color', get_value_input('background-color'));
                                            ?>
                                        </td>
                                    </tr>
                                    <tr class="tr-background-color">
                                        ...
                                        <td>
                                            <?php
                                            echo theme_input_color('wrapper-background-color', get_value_input('wrapper-background-color'));
                                            ?>
                                        </td>
                                    </tr>
                                </tbody>
                                <tfoot class="tr-background-image">
                                    <tr class="tr-background-image">
                                        ...
                                        <td>
                                            <?php echo theme_input_get_image('background-image', get_value_input('background-image')); ?>
                                        </td>
                                    </tr>
                                    <tr class="tr-background-image">
                                        <?php echo theme_background_position('background-position', get_value_input('background-position')); ?>
                                    </tr>
                                    <tr class="tr-background-image">
                                        <?php echo theme_background_repeat('background-repeat', get_value_input('background-repeat')); ?>
                                    </tr>
                                    <tr class="tr-background-image">
                                        <?php echo theme_background_attachment('background-attachment', get_value_input('background-attachment')); ?>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
            ...
            <?php echo Pf::event()->trigger("filter","page-adding-form"); ?>
        </form>
...
function Page_New(){
	...
	$.post($('#frm_Page_New').attr('action'),$('#frm_Page_New').serialize(),function(obj){
		$("#main-content").unmask();
		if (obj.error == 1){
			...
			$.notification({type:"success",img:"",width:"400",content:"<i class='fa fa-check fa-2x'></i> <?php echo __('Page is added successfully','page'); ?>",html:true,autoClose:true,timeOut:"1500",delay:"0",position:"topRight",effect:"fade",animate:"fadeUp",easing:"jswing",onStart:function(id){ console.log(' onStart : notification id = '+id); },onShow:function(id){ console.log(' onShow : notification id = '+id); },onClose:function(id){ console.log(' onClose : notification id = '+id); },duration:"300"});
