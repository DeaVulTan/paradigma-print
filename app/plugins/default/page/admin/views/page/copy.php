...
<div class="row" style="margin-bottom: 20px;margin-top:-15px;">
    <div class="col-sm-12">
        <h3>
            ...
            <?php } ?>
            <?php echo __('Pages','page'); ?>  <small><?php echo __('Copy','page'); ?></small>
        </h3>
    </div>
...
<div class="row">
    <div class="col-sm-12">
        <form name="frm_Page_Copy" id="frm_Page_Copy" class="form-horizontal" role="form" action="<?php echo admin_url('token='.$this->token); ?>" method="post" onsubmit="return false;">
            ...
            <?php echo Pf::event()->trigger("filter","page-copy-form"); ?>
        </form>
...
function Page_Copy(){
	...
	$.post($('#frm_Page_Copy').attr('action'),$('#frm_Page_Copy').serialize(),function(obj){
		$("#main-content").unmask();
		if (obj.error == 1){
			...
			$.notification({type:"success",img:"",width:"400",content:"<i class='fa fa-check fa-2x'></i> <?php echo __('Page is copied successfully','page'); ?>",html:true,autoClose:true,timeOut:"1500",delay:"0",position:"topRight",effect:"fade",animate:"fadeUp",easing:"jswing",onStart:function(id){ console.log(' onStart : notification id = '+id); },onShow:function(id){ console.log(' onShow : notification id = '+id); },onClose:function(id){ console.log(' onClose : notification id = '+id); },duration:"300"});
