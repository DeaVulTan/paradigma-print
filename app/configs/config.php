...
define('__SECURITY_SALT__', 'yafHH8gt2Lk4EWY9Q3ZSCigde0HgVzAjzFQ7EXqw');

// A random numeric string (digits only) used to encrypt/decrypt strings.
define('__SECURITY_CIPHER_SEED__', '44282089976487595003444891849');
